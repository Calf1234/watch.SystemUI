...
public class NetworkControllerImpl extends BroadcastReceiver
    ...
    private boolean mHasNoSim0;
    private boolean mHasNoSim1;
    ...
    private boolean mIsSignalStrengthExt = false;
    /**
    ...
    NetworkControllerImpl(Context context, ConnectivityManager connectivityManager,
        ...
        mIsSignalStrengthExt = mContext.getResources().getBoolean(
			                com.android.internal.R.bool.config_signalStrengthExt);
    ...
    public void addNetworkSignalChangedCallback(NetworkSignalChangedCallback cb) {
        ...
        cb.onNoSimVisibleChanged(mHasNoSim0, 0);
        cb.onNoSimVisibleChanged(mHasNoSim1, 1);
        mWifiSignalController.notifyListeners();
        for (MobileSignalController mobileSignalController : mMobileSignalControllers.values()) {
            mobileSignalController.notifyListeners();
        }
    ...
    protected void updateNoSims() {
        ...
        boolean hasNoSim0 = mHasNoSim0;
        boolean hasNoSim1 = mHasNoSim1;

        int[] slot0SubId = SubscriptionManager.getSubId(0);
        int[] slot1SubId = SubscriptionManager.getSubId(1);
        if (slot0SubId != null) {
            hasNoSim0 = !mMobileSignalControllers.containsKey(slot0SubId[0]);
        }
        if (slot1SubId != null) {
            hasNoSim1 = !mMobileSignalControllers.containsKey(slot1SubId[0]);
        }
        if (hasNoSims != mHasNoSims || hasNoSim0 != mHasNoSim0 || hasNoSim1 != mHasNoSim1) {
            mHasNoSims = hasNoSims;
            mHasNoSim0 = hasNoSim0;
            mHasNoSim1 = hasNoSim1;
            notifyListeners();
        }
    }
    ...
    private void notifyListeners() {
        ...
        for (int i = 0; i < signalsChangedLength; i++) {
            ...
            mSignalsChangedCallbacks.get(i).onNoSimVisibleChanged(mHasNoSim0, 0);
            mSignalsChangedCallbacks.get(i).onNoSimVisibleChanged(mHasNoSim1, 1);
        }
    }
            ...
            if (mobile != null) {
                ...
                if (datatype != null) {
                    if (mIsSignalStrengthExt) {
                        ...
                        controller.getState().iconGroup =
                                datatype.equals("1x") ? TelephonyIcons.ONE_X :
                                datatype.equals("3g") ? TelephonyIcons.THREE_G_EXT :
                                datatype.equals("4g") ? TelephonyIcons.FOUR_G_EXT :
                                datatype.equals("e") ? TelephonyIcons.E_EXT :
                                datatype.equals("g") ? TelephonyIcons.G_EXT :
                                datatype.equals("h") ? TelephonyIcons.H_EXT :
                                datatype.equals("lte") ? TelephonyIcons.LTE_EXT :
                                datatype.equals("roam") ? TelephonyIcons.ROAMING_EXT :
                                TelephonyIcons.UNKNOWN_EXT;
                    }
                }
                int[][] icons = mIsSignalStrengthExt ? TelephonyIcons.TELEPHONY_SIGNAL_STRENGTH_EXT
        ...
        public void notifyListeners() {
            ...
            for (int i = 0; i < signalClustersLength; i++) {
                mSignalClusters.get(i).setWifiIndicators(wifiVisible, getCurrentIconId(),
                        contentDescription,ssidPresent && mCurrentState.activityIn,ssidPresent && mCurrentState.activityOut);
            }
        }
    ...
    public static class MobileSignalController extends SignalController<
        ...
        private Config mConfig;
        private boolean mIsSignalStrengthExt;
        ...
        public MobileSignalController(Context context, Config config, boolean hasMobileData,
            ...
            mIsSignalStrengthExt = context.getResources().getBoolean(
                    com.android.internal.R.bool.config_signalStrengthExt);
        ...
        private void mapIconSets() {
            ...
            if (mIsSignalStrengthExt) {
                mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EVDO_0,
                        TelephonyIcons.THREE_G);
                mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EVDO_A,
                        TelephonyIcons.THREE_G);
                mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EVDO_B,
                        TelephonyIcons.THREE_G);
                mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EHRPD,
                        TelephonyIcons.THREE_G);
                mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_UMTS,
                        TelephonyIcons.THREE_G_EXT);

                if (!mConfig.showAtLeast3G) {
                    mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_UNKNOWN,
                            TelephonyIcons.UNKNOWN_EXT);
                    mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EDGE,
                            TelephonyIcons.E_EXT);
                    ...
                    mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_1xRTT,
                            TelephonyIcons.THREE_G);
                    mDefaultIcons = TelephonyIcons.THREE_G_EXT;
                }

                MobileIconGroup hGroup = TelephonyIcons.THREE_G_EXT;
                if (mConfig.hspaDataDistinguishable) {
                    hGroup = TelephonyIcons.H_EXT;
                }
                ...
                if (mConfig.show4gForLte) {
                    mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_LTE,
                            TelephonyIcons.FOUR_G_EXT);
                } else {
                    mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_LTE,
                            TelephonyIcons.LTE_EXT);
                }
                return;
            }
        ...
        public void notifyListeners() {
            ...
            int sltoId = SubscriptionManager.getSlotId(subId);
            ...
            showDataIcon = mCurrentState.dataConnected && mCurrentState.inetForNetwork != 0
                    || mCurrentState.iconGroup == TelephonyIcons.ROAMING
                    || mCurrentState.iconGroup == TelephonyIcons.ROAMING_EXT;
            ...
            for (int i = 0; i < signalClustersLength; i++) {
                if(!UXFEATURE){
                    ...
                    mSignalClusters.get(i).setMobileDataIndicatorsUX(
                            mCurrentState.enabled && !mCurrentState.airplaneMode,
                            getCurrentIconId(),
                            typeIcon,
                            contentDescription,
        ...
        private final void updateTelephony() {
            ...
            if (isRoaming()) {
                mCurrentState.iconGroup = mIsSignalStrengthExt ? TelephonyIcons.ROAMING_EXT
                        : TelephonyIcons.ROAMING;
            }
    ...
    public interface SignalCluster {
        void setWifiIndicators(boolean visible, int strengthIcon, String contentDescription,boolean activityIn, boolean activityOut);
        ...
        void setMobileDataIndicators(boolean visible, int strengthIcon, int typeIcon,
                ...
                int subId);
        /**@hide*/
        void setMobileDataIndicatorsUX(boolean visible, int strengthIcon, int typeIcon,
        String contentDescription, String typeContentDescription, boolean isTypeIconWide,
