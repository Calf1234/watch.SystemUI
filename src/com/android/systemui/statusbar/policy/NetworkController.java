...
public interface NetworkController {
    ...
    public interface NetworkSignalChangedCallback {
        ...
        void onNoSimVisibleChanged(boolean visible, int slotId);
    ...
    public interface MobileDataController {
        ...
        void setMobileDataEnabled(int subId, boolean enabled, boolean refresh);
        DataUsageInfo getDataUsageInfo();
        DataUsageInfo getDataUsageInfo(int subId, String carrierName);
