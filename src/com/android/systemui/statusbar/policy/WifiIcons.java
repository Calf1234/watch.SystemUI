...
public class WifiIcons {
    ...
    public static final int QS_WIFI_NO_NETWORK = R.drawable.ic_qs_wifi_no_network;
    public static final int WIFI_NO_NETWORK = R.drawable.stat_sys_wifi_signal_null;
