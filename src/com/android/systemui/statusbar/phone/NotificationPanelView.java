...
import com.android.keyguard.ClockView;
...
public class NotificationPanelView extends PanelView implements
    ...
    private ClockView mClockViewUX;
    ...
    protected void onFinishInflate() {
        ...
        if(!UXFEATURE){
            ...
            mClockViewUX = (ClockView) findViewById(R.id.clock_view_ux);
        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if(!UXFEATURE){
            ...
            mKeyguardStatusView.setPivotY((FONT_HEIGHT - CAP_HEIGHT) / 2048f * mClockViewUX.getTextSize());
        }
