...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mBatterPercent;
    ...
    public void init() {
        ...
        mBatterPercent = mView.findViewById(R.id.battery_percent);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mBatterPercent, newAlphaBC),
            ...
            mBatterPercent.setAlpha(newAlphaBC);
