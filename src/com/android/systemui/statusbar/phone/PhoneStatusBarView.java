    ...
    private void registerContentChangeListener() {
        mObserver = new ContentObserver(new Handler()) {
            ...
            public void onChange(boolean selfChange) {
                boolean show = (0 != Settings.System.getInt(
                        getContext().getContentResolver(),
                        Settings.System.BATTERY_PERCENTAGE_SHOW,
                        0 /*default */));
                android.util.Log.d("hellcat", "onChange -> mShowPercent = " + show);
                View view = PhoneStatusBarView.this.findViewById(R.id.battery_percent);
                if(view != null){
        ...
        getContext().getContentResolver().registerContentObserver(
                Settings.System.getUriFor(Settings.System.BATTERY_PERCENTAGE_SHOW), true,
                mObserver);
    }
